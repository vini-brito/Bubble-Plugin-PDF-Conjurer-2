function(instance, properties, context) {
   ...
   // console.log("Sequentially is", sequentiallyRepeatedElements)
    ...
    let flattenedMixedSeries = mixedSeriesOfElements.flat();

   // console.log("Flattened mixed series is", flattenedMixedSeries)

    // now everything goes in order into 
    instance.data.composeInMe.push(...flattenedMixedSeries)

   // console.log("Compose in me is", instance.data.composeInMe)
